...
public class RedCloseSimple {
    public static void main(String[] args) {
        ...
        TrajectoryActionBuilder firstLaunch = bot.getDrive().actionBuilder(initialPose).strafeToLinearHeading(new Vector2d(-16,26), Math.toRadians(90));
        TrajectoryActionBuilder firstPickup = firstLaunch.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(-11,28)).strafeToConstantHeading(new Vector2d(-11,48), new TranslationalVelConstraint(6));
