...
public class TurretEncoderTester extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Relative Turret Angle (Degrees): ", turretEncoder.getRelativeTurretAngleDegrees());
        telemetry.addData("Get Current Position: ", turretEncoder.getCurrentPosition());
        telemetry.update();
    }
}
