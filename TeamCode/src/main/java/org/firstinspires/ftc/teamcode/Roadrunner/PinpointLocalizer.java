...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -4265.502110964951; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 260.87838237407686; // x position of the perpendicular encoder (in tick units)
    }
