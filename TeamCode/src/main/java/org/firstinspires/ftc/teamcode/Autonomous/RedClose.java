...
public class RedClose extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder firstPickup = firstLaunch.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(-11,31.5)).strafeToConstantHeading(new Vector2d(-11,48), new TranslationalVelConstraint(5.5));
        ...
        TrajectoryActionBuilder secondPickup = secondLaunch.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(12, 31.5)).strafeToConstantHeading(new Vector2d(12,48) , new TranslationalVelConstraint(5.5));
        TrajectoryActionBuilder thirdLaunch = secondPickup.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(-14,22));
        TrajectoryActionBuilder thirdPickup = thirdLaunch.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(36.5, 31)).strafeToConstantHeading(new Vector2d(36.5,48), new TranslationalVelConstraint(5.5));
