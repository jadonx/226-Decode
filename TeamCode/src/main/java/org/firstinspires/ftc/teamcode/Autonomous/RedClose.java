...
public class RedClose extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder firstPickup = firstLaunch.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(-13,31.5)).strafeToConstantHeading(new Vector2d(-13,48), new TranslationalVelConstraint(5.5));
        ...
        TrajectoryActionBuilder thirdPickup = thirdLaunch.endTrajectory().fresh().strafeToConstantHeading(new Vector2d(36, 30)).strafeToConstantHeading(new Vector2d(36,48), new TranslationalVelConstraint(5.5));
